...
*/
  ...
  brasil.unshift("Tocantins", "Pará", "Amapá");
  console.log(brasil);
...
*/
  ...
  var hasMoreThanSevenLetters = brasil.every(function (item) {
    return item.length > 7;
  });
  console.log(
    hasMoreThanSevenLetters
      ? "Sim, todos os estados tem mais de 7 letras"
      : "Nem todos os estados tem mais de 7 letras"
  );
...
*/
  ...
  var isCearaHere = brasil.some(function (item) {
    return item === "Ceará";
  });
  console.log(
    isCearaHere ? "Ceará está incluído!" : "Ceará não foi incluído :("
  );
