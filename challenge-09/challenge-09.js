...
tem dois parâmetros disponíveis, que são os números que você acabou de passar
...
*/
  console.log(
    `O resultado da soma é: ${sum(function (x, y) {
      return x + y;
    })}`
  );
  // ?
...
*/
  var subtraction = calculator(4, 2);
  var multiplication = calculator(12, 4);
  var division = calculator(20, 6);
  var mod = calculator(32, 8);
